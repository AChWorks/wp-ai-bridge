...
return array(
	...
	'Allow authorized MCP clients to inspect and update protected/private post, term, user, and comment metadata for exact WordPress objects the connected user may edit. Options, Workspace internals, role/capability/session/application-password state, and credential-like keys remain outside this surface.' => 'به کلاینت‌های مجاز MCP اجازه می‌دهد فرادادهٔ محافظت‌شده/خصوصی نوشته‌ها، اعضای رده‌بندی، کاربران و دیدگاه‌ها را برای اشیای دقیق وردپرس که کاربر متصل اجازهٔ ویرایششان را دارد بررسی و به‌روزرسانی کنند. تنظیمات options، داده‌های داخلی فضای کاری، وضعیت نقش/قابلیت/نشست/Application Password و کلیدهای شبیه اطلاعات احراز هویت یا محرمانه خارج از این سطح باقی می‌مانند.',
