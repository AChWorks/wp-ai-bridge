...
base_url="${WPAI_HTTP_BASE_URL:-http://127.0.0.1:18080}"
public_origin="${WPAI_PUBLIC_ORIGIN:-https://localhost}"
host_header="${WPAI_HTTP_HOST:-localhost}"
...
echo 'PASS: canonical OAuth discovery/MCP challenge, issuer error redirect, and open-redirect rejection over real HTTP.'
