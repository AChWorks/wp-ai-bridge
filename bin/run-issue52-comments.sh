...
export COMPOSE_PROJECT_NAME="wpai-issue52-${safe_tag}-$$"
...
"${compose[@]}" cp "$root/tests/integration/issue52-comment-administration-smoke.php" wordpress:/var/www/html/wp-content/plugins/wp-ai-bridge/tests/integration/issue52-comment-administration-smoke.php
...
"${wp[@]}" eval-file wp-content/plugins/wp-ai-bridge/tests/integration/issue52-comment-administration-smoke.php --user=1 --allow-root
